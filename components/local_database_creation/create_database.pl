...
system("mysql -u root < \"db/data/development/TRUNCATE CIS Data.sql\"") and die "Truncate failed\n";

print "[*** ] Importing CIS course data\n";
system("mysql -u root < \"db/data/development/CIS Data.sql\"") and die "Data import failed\n";
