...
#this test shows that you can add a new user
  def test_add_new_user
      user = User.new(:username=>'forest', :password_hash=>Digest::SHA1.hexdigest("gump"), :start_year=>'2009', :start_sem=>'FA', :birthday=>'1990-10-29', :college => College.find(:first))
      user.save
      puts user.id
...
#  this test shows that you can all user's excluding this user
  def test_addFriends
      bFound = false;
      user1 = User.new(:username=>'forest1', :password_hash=>Digest::SHA1.hexdigest("gump1"), :start_year=>'2009', :start_sem=>'FA', :birthday=>'1990-10-29', :college => College.find(:first))
      user2 = User.new(:username=>'forest2', :password_hash=>Digest::SHA1.hexdigest("gump2"), :start_year=>'2007', :start_sem=>'FA', :birthday=>'1930-10-29', :college => College.find(:first))
      user1.save
      user2.save
      @friends_all = User.find :all, :order => 'last_name ASC, first_name ASC'  
